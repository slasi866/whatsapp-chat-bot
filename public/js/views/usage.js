...
export async function render() {
  ...
  return h(
    ...
    h(
      ...
      statTile({
        label: 'Token input',
        value: fmtNumber(usage.this_month.input_tokens),
        count: usage.this_month.input_tokens,
        format: fmtNumber,
      }),
      statTile({
        label: 'Token output',
        value: fmtNumber(usage.this_month.output_tokens),
        count: usage.this_month.output_tokens,
        format: fmtNumber,
      }),
      statTile({
